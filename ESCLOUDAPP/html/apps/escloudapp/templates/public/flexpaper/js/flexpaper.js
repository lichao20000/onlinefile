...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _fileId  			= (config.fileId!=null?config.fileId:_fileId);
    _baseUrl  			= (config.baseUrl!=null?config.baseUrl:_baseUrl);
    ...
    function Flash(root, opts, conf) {
        ...
        if (f.isSupported(opts.version)) {
            ...
            if (!root.innerHTML.replace(/\s/g, '')) {
                ...
                root.innerHTML =
                    "<h2>您的 Adobe Flash Player 与文档浏览器不匹配</h2>" +
                        "<h3>请下载 Adobe Flash Player 10 或更高版本.</h3>" +
                        "<p>点击图标下载最新的 Adobe Flash" +
                        "<a href='http://www.adobe.com/go/getflashplayer'><img src='"
                        + pageHost + "www.adobe.com/images/shared/download_buttons/get_flash_player.gif' alt='下载  Adobe Flash player' /></a>";
