 ...
 * 
 * An Ext state provider implementation for Adobe AIR that stores state in the
...
Ext.extend(Ext.air.FileProvider, Ext.state.Provider, {
			/**
			 * @cfg {String} file The file name to use for the state file in the
			 *      application storage directory
			 */
			file : 'extstate.data',

			/**
			 * @cfg {Object} defaultState The default state if no state file can
			 *      be found
			 */
			// private
			readState : function() {
