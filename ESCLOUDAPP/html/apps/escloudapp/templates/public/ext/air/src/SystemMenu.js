 ...
 * 
 * Provides platform independent handling of adding item to the application
 * menu, creating the menu or items as needed. <br/><br/>
 * 
 * This class also provides the ability to bind standard Ext.Action instances
 * with NativeMenuItems
 * 
 * @singleton
 */
Ext.air.SystemMenu = function() {
	...
	return {
		 ...
		 * 
		 * @param {String}
		 *            text The application menu to add the actions to (e.g.
		 *            'File' or 'Edit').
		 * @param {Array}
		 *            actions An array of Ext.Action objects or menu item
		 *            configs
		 * @param {Number}
		 *            mindex The index of the character in "text" which should
