 ...
 * @extends Ext.data.Store Small helper class to make creating Stores from Array
 *          data easier.
 * @cfg {Number} id The array index of the record id. Leave blank to auto
 *      generate ids.
 * @cfg {Array} fields An array of field definition objects, or field name
 *      strings.
