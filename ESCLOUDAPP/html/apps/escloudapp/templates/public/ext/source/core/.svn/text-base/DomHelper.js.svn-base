...
/**
 * @class Ext.DomHelper Utility class for working with DOM and/or Templates. It
 ...
 * 
 * <p>
 *        Element creation specification parameters in this class may also be
 *        passed as an Array of specification objects. This can be used to
 *        insert multiple sibling nodes into an existing container very
 *        efficiently. For example, to add more list items to the example above:
 * 
 * <pre><code>
 * dh.append('my-ul', [{
 * 					tag : 'li',
 ...
 * </p>
 *        <p>
 *        Element creation specification parameters may also be strings. If
 *        {@link useDom} is false, then the string is used as innerHTML. If
 *        {@link useDom} is true, a string specification results in the creation
 *        of a text node.
 *        </p>
...
Ext.DomHelper = function() {
	...
	return {
		 ...
		 *            styles A style specification string eg "width:100px", or
		 *            object in the form {width:"100px"}, or a function which
		 ...
		 * 
		 * @param {String}
		 *            where Where to insert the html in relation to el -
		 ...
		 *            el The context element
		 * @param {Object/String}
		 *            o The DOM object spec (and children) or raw HTML blob
		 * @param {Boolean}
		 *            returnElement (optional) true to return a Ext.Element
