 ...
 *          automatically expands to fill the layout's container. This class is
 *          intended to be extended or created via the layout:'fit'
 ...
 *          it. If the container has multiple panels, only the first one will be
