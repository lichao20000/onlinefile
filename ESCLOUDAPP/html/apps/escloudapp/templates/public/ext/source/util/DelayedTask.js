...
/**
 * @class Ext.util.DelayedTask Provides a convenient method of performing
 *        setTimeout where a new timeout cancels the old timeout. An example
 *        would be performing validation on a keypress. You can use this class
 *        to buffer the keypress events for a certain number of milliseconds,
 *        and perform only if they stop for that amount of time.
 * @constructor The parameters to this constructor serve as defaults and are not
 *              required.
 * @param {Function}
