/*
 * France (France) translation By Thylia 09-11-2007, 02:22 PM
 */
...
Date.monthNames = ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin",
...
Date.dayNames = ["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi",
		"Samedi"];
