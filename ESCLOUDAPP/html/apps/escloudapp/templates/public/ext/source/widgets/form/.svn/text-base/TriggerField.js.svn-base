 ...
 * @extends Ext.form.TextField Provides a convenient wrapper for TextFields that
 *          adds a clickable trigger button (looks like a combobox by default).
 *          The trigger has no default action, so you must assign a function to
 *          implement the trigger click handler by overriding
 *          {@link #onTriggerClick}. You can create a TriggerField directly, as
 *          it renders exactly like a combobox for which you can provide a
 ...
 * class for a reusable component. {@link Ext.form.DateField} and
 * {@link Ext.form.ComboBox} are perfect examples of this.
 * @cfg {String} triggerClass An additional CSS class used to style the trigger
 *      button. The trigger will always get the class 'x-form-trigger' by
 *      default and triggerClass will be <b>appended</b> if specified.
 * @constructor Create a new TriggerField.
 * @param {Object}
 *            config Configuration options (valid {@Ext.form.TextField} config
 *            options will also be applied to the base TextField)
 */
Ext.form.TriggerField = Ext.extend(Ext.form.TextField, {
	 ...
	 *      only the base text field (defaults to false)
	 */
	hideTrigger : false,
