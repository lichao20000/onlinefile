...
Ext.grid.EditorGridPanel = Ext.extend(Ext.grid.GridPanel, {
	/**
	 * @cfg {Number} clicksToEdit The number of clicks on a cell required to
	 *      display the cell's editor (defaults to 2)
	 */
	clicksToEdit : 2,
	...
	/**
	 * @cfg {Boolean} autoEncode True to automatically HTML encode and decode
	 *      values pre and post edit (defaults to false)
	 */
	autoEncode : false,
	...
	initComponent : function() {
		...
		if (!this.selModel) {
			/**
			 * @cfg {Object} selModel Any subclass of AbstractSelectionModel
			 *      that will provide the selection model for the grid (defaults
			 *      to {@link Ext.grid.CellSelectionModel} if not specified).
			 */
		...
		this.addEvents(
				/**
				 * @event beforeedit Fires before cell editing is triggered. The
				 *        edit event object has the following properties <br />
				 ...
				 *        <li>cancel - Set this to true to cancel the edit or
				 *        return false from your handler.</li>
				 *        </ul>
				 * @param {Object}
				 ...
				 *        <li>originalValue - The original value for the field,
				 *        before the edit.</li>
				 *        <li>row - The grid row index</li>
				 *        <li>column - The grid column index</li>
				 *        </ul>
				...
				"afteredit",
				/**
				 * @event validateedit Fires after a cell is edited, but before
	...
	onEditComplete : function(ed, value, startValue) {
		...
		startValue = this.postEditValue(startValue, startValue, r, field); /** niuhe 20130604 add to encode startValue**/
