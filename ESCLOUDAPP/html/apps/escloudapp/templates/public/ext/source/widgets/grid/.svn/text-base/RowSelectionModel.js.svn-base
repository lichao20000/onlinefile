 ...
 * @extends Ext.grid.AbstractSelectionModel The default SelectionModel used by
 *          {@link Ext.grid.GridPanel}. It supports multiple selections and
 *          keyboard selection/navigation. The objects stored as selections and
 *          returned by {@link #getSelected}, and {@link #getSelections} are
 *          the {@link Ext.data.Record Record}s which provide the data for the
 *          selected rows.
 * @constructor
 * @param {Object}
 *            config
...
Ext.grid.RowSelectionModel = function(config) {
	...
	this.addEvents(
			/**
			 * @event selectionchange Fires when the selection changes
			 * @param {SelectionModel}
			 *            this
			 */
			"selectionchange",
			/**
			 * @event beforerowselect Fires when a row is being selected, return
			 *        false to cancel.
			 * @param {SelectionModel}
			 *            this
			 * @param {Number}
			 *            rowIndex The index to be selected
			 * @param {Boolean}
			 *            keepExisting False if other selections will be cleared
			 * @param {Record}
			 *            record The record to be selected
			 */
			"beforerowselect",
			/**
			 * @event rowselect Fires when a row is selected.
			 * @param {SelectionModel}
			 *            this
			 * @param {Number}
			 *            rowIndex The selected index
			 * @param {Ext.data.Record}
			 *            r The selected record
			 */
			"rowselect",
			/**
			 * @event rowdeselect Fires when a row is deselected.
			 * @param {SelectionModel}
			 *            this
			 * @param {Number}
			 *            rowIndex
...
Ext.extend(Ext.grid.RowSelectionModel, Ext.grid.AbstractSelectionModel, {
	/**
	 * @cfg {Boolean} singleSelect True to allow selection of only one row at a
	 *      time (defaults to false)
	 */
	singleSelect : false,

	/**
	 * @cfg {Boolean} moveEditorOnEnter False to turn off moving the editor to
	 *      the next cell when the enter key is pressed
	 */
	// private
	initEvents : function() {
	 ...
	 * false, iteration is stopped and this function returns false. Otherwise it
	 * returns true.
	 * 
	 * @param {Function}
	 *            fn
	...
	/**
	 * Deselects a range of rows. All rows in between startRow and endRow are
	 * also deselected.
	 * 
	 * @param {Number}
	 *            startRow The index of the first row in the range
