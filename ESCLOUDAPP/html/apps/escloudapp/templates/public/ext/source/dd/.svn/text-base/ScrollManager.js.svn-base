 ...
 *        <p>
 *        Provides automatic scrolling of overflow regions in the page during
 *        drag operations.
 *        </p>
 *        <p>
 *        The ScrollManager configs will be used as the defaults for any scroll
 *        container registered with it, but you can also override most of the
 *        configs per scroll container by adding a <tt>ddScrollConfig</tt>
 *        object to the target element that contains these properties:
 *        {@link #hthresh}, {@link #vthresh}, {@link #increment} and
 *        {@link #frequency}. Example usage:
 * 
 * <pre><code>
