...
Ext.util.Observable.prototype = {
	 ...
	 *            {@link Ext.util.DelayedTask} delayed by the specified number
	 *            of milliseconds. If the event fires again within that time,
	 *            the original handler is <em>not</em> invoked, but the new
	 ...
	 * were fired by <tt><b>this</b></tt>.
	 * 
	 * @param {Object}
	 *            o The Observable whose events this object is to relay.
	 * @param {Array}
