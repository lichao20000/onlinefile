 ...
 * </code></pre>
 * 
 * This would pass an HTTP parameter called "category" to the server
 *          containing the value of the Node's "category" attribute.
...
Ext.extend(Ext.tree.TreeLoader, Ext.util.Observable, {
			 ...
			 *      data (defaults to the value of {@link Ext.Ajax#method}).
			 */
			/**
			 ...
			 *      reference to a TreeNodeUI implementation, then that string
