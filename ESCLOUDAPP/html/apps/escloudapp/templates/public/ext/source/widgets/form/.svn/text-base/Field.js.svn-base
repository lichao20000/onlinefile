 ...
 * @extends Ext.BoxComponent Base class for form fields that provides default
 *          event handling, sizing, value handling and other functionality.
...
Ext.form.Field = Ext.extend(Ext.BoxComponent, {
	 ...
	 */
	/**
	 * @cfg {String} labelStyle A CSS style specification to apply directly to
	 *      this field's label (defaults to the container's labelStyle value if
	 *      set, or ''). For example,
	 *      <code>labelStyle: 'font-weight:bold;'</code>.
	 */
	/**
	 * @cfg {String} labelSeparator The standard separator to display after the
	 *      text of each form label (defaults to the value of
	 *      {@link Ext.layout.FormLayout#labelSeparator}, which is a colon ':'
	 *      by default). To display no separator for this field's label specify
	 *      empty string ''.
	 */
	/**
	 * @cfg {Boolean} hideLabel True to completely hide the label element
	 *      (defaults to false)
	 */
	/**
	 ...
	 */
	/**
	 * @cfg {String} itemCls An additional CSS class to apply to the wrapper's
	 *      form item element of this field (defaults to the container's itemCls
	 *      value if set, or ''). Since it is applied to the item wrapper, it
	 *      allows you to write standard CSS rules that can apply to the field,
	 *      the label (if specified) or any other element within the markup for
	 *      the field. NOTE: this will not have any effect on fields that are
	 *      not part of a form. Example use:
	 * 
	 * <pre><code>
	 ...
	 */
	/**
	 * @cfg {String} inputType The type attribute for input fields -- e.g.
	 *      radio, text, password, file (defaults to "text"). The types "file"
	 *      and "password" must be used to render those field types currently --
	 *      there are no separate Ext components for those. Note that if you use
	 *      <tt>inputType:'file'</tt>, {@link #emptyText} is not supported
	 ...
	 *      invalid and no message is provided (defaults to "The value in this
	 *      field is invalid")
	 */
	invalidText : "The value in this field is invalid",
	/**
	 * @cfg {String} focusClass The CSS class to use when the field receives
	 *      focus (defaults to "x-form-focus")
	 */
	...
	/**
	 * @cfg {Boolean} validateOnBlur Whether the field should validate when it
	 *      loses focus (defaults to true).
	 */
	validateOnBlur : true,
	/**
	 * @cfg {Number} validationDelay The length of time in milliseconds after
	 *      user input begins until validation is initiated (defaults to 250)
	 */
	validationDelay : 250,
	/**
	 ...
	 *      (defaults to false) -- Note: this only sets the element's readOnly
	 *      DOM attribute.
	 */
	readOnly : false,
	/**
	...
	initComponent : function() {
		...
		this.addEvents(
				/**
				 * @event focus Fires when this field receives input focus.
				 * @param {Ext.form.Field}
				 *            this
				 */
				'focus',
				/**
				 * @event blur Fires when this field loses input focus.
				 * @param {Ext.form.Field}
				 *            this
				 */
				'blur',
				...
				'specialkey',
				/**
				 * @event change Fires just before the field blurs if the field
				 *        value has changed.
				 * @param {Ext.form.Field}
				 *            this
				 * @param {Mixed}
				...
				'change',
				/**
				 * @event invalid Fires after the field has been marked as
				 *        invalid.
				 * @param {Ext.form.Field}
				 *            this
				 * @param {String}
	...
	// private
	getErrorCt : function() {
		return this.el.findParent('.x-form-element', 5, true) || // use form
																	// element
																	// wrap if
																	// available
