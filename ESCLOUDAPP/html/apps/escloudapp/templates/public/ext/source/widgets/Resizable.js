...
Ext.Resizable = function(el, config) {
	...
	/**
	 * The proxy Element that is resized in place of the real Element during the
	 * resize operation. This may be queried using {@link Ext.Element#getBox} to
	 * provide the new area to resize to. Read only.
	 * 
	 * @type Ext.Element.
	 * @property proxy
	 */
...
Ext.extend(Ext.Resizable, Ext.util.Observable, {
			...
			/**
			 * <p>
			 * Performs resizing of the associated Element. This method is
			 * called internally by this class, and should not be called by user
			 * code.
			 * </p>
			 * <p>
			 * If a Resizable is being used to resize an Element which
			 * encapsulates a more complex UI component such as a Panel, this
			 * method may be overridden by specifying an implementation as a
			 * config option to provide appropriate behaviour at the end of the
			 * resize operation on mouseup, for example resizing the Panel, and
			 * relaying the Panel's content.
			 * </p>
			 * <p>
			 * The new area to be resized to is available by examining the state
			 * of the {@link #proxy} Element. Example:
			 * 
			 * <pre><code>
			 * new Ext.Panel({
			 * 			title : 'Resize me',
