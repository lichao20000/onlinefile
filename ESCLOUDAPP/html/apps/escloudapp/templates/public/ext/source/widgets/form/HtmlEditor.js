 ...
 * @extends Ext.form.Field Provides a lightweight HTML Editor component. Some
 *          toolbar features are not supported by Safari and will be
 *          automatically hidden when needed. These are noted in the config
 *          options where appropriate. <br>
 *          <br>
 *          The editor's toolbar buttons have tooltips defined in the
 *          {@link #buttonTips} property, but they are not enabled by default
 *          unless the global {@link Ext.QuickTips} singleton is
 *          {@link Ext.QuickTips#init initialized}. <br>
 *          <br>
 *          <b>Note: The focus/blur and validation marking functionality
 *          inherited from Ext.form.Field is NOT supported by this editor.</b>
 *          <br>
 *          <br>
 *          An Editor is a sensitive component that can't be used in all spots
 *          standard fields can be used. Putting an Editor within any element
 *          that has display set to 'none' can cause problems in Safari and
 *          Firefox due to their default iframe reloading bugs. <br>
 *          <br>
 *          Example usage:
 * 
 * <pre><code>
 ...
 * </code></pre>
 * 
 * @constructor Create a new HtmlEditor
 * @param {Object}
 *            config
 */
...
Ext.form.HtmlEditor = Ext.extend(Ext.form.Field, {
	...
	enableFormat : true,
	/**
	 * @cfg {Boolean} enableFontSize Enable the increase/decrease font size
	...
	enableColors : true,
	/**
	 * @cfg {Boolean} enableAlignments Enable the left, center, right alignment
	 *      buttons (defaults to true)
	 */
	enableAlignments : true,
	/**
	 * @cfg {Boolean} enableLists Enable the bullet and numbered list buttons.
	...
	/**
	 * @cfg {Boolean} enableLinks Enable the create link button. Not available
	...
	/**
	 * @cfg {String} defaultLinkValue The default value for the create link
	...
	initComponent : function() {
		this.addEvents(
				/**
				 * @event initialize Fires when the editor is fully initialized
				...
				'initialize',
				/**
				 * @event activate Fires when the editor is first receives the
				 *        focus. Any insertion must wait until after this event.
				 * @param {HtmlEditor}
				 *            this
				 */
				'activate',
				/**
				 * @event beforesync Fires before the textarea is updated with
				 *        content from the editor iframe. Return false to cancel
				 *        the sync.
				 * @param {HtmlEditor}
				 *            this
				 * @param {String}
				...
				'beforesync',
				/**
				 * @event beforepush Fires before the iframe editor is updated
				 *        with content from the textarea. Return false to cancel
				 *        the push.
				 * @param {HtmlEditor}
				 *            this
				 * @param {String}
				...
				'beforepush',
				/**
				 * @event sync Fires when the textarea is updated with content
				 *        from the editor iframe.
				 * @param {HtmlEditor}
				 *            this
				 * @param {String}
				 *            html
				...
				'sync',
				/**
				 * @event push Fires when the iframe editor is updated with
				...
				'push',
				/**
				 * @event editmodechange Fires when the editor switches edit
				 *        modes
				 * @param {HtmlEditor}
				 *            this
				 * @param {Boolean}
				 *            sourceEdit True if source edit, false if standard
				 *            editing.
				 */
				'editmodechange')
	},
	 ...
	 * when the editor creates its toolbar. Override this method if you need to
	 * add custom toolbar buttons. @param {HtmlEditor} editor
	 */
...
(function() {
	...
	/**
	 * Returns the editor's toolbar. <b>This is only available after the editor
	 * has been rendered.</b>
	 * 
	 * @return {Ext.Toolbar}
	 */
	...
	buttonTips : {
		 ...
		 */
		/**
		 * @cfg {String} validationDelay
		 * @hide
		 */
		/**
		 * @cfg {String} validationEvent
		 * @hide
		 */
		/**
		 * @cfg {String} tabIndex
