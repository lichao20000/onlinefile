 ...
 *          supports multiple nested panels, automatic split bars between
 *          regions and built-in expanding and collapsing of regions. This class
 *          is intended to be extended or created via the layout:'border'
 ...
 *          inherited ones). All configs available for customizing the
 *          BorderLayout are at the {@link Ext.layout.BorderLayout.Region} and
 *          {@link Ext.layout.BorderLayout.SplitRegion} levels.
 *          </p>
 *          <p>
 *          <b>The regions of a BorderLayout are fixed at render time and
 *          thereafter, no regions may be removed or added.</b>
 *          </p>
 *          <p>
 *          Example usage:
 *          </p>
...
Ext.layout.BorderLayout.Region.prototype = {
	 ...
	 */
	/**
	 * @cfg {Boolean} collapsed By default, collapsible regions will be visible
	 *      when rendered. Set the collapsed config to true to render the region
	 *      as collapsed.
	 */
	/**
	 ...
	 *      specify a minSize and maxSize for the BoxComponent representing the
	 *      region. These are not native configs of BoxComponent, and are used
	 *      only by this class.
	 */
	split : false,
	/**
