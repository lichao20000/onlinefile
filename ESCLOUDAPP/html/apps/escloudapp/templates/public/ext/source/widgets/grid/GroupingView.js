...
Ext.grid.GroupingView = Ext.extend(Ext.grid.GridView, {
	...
	ignoreAdd : false,
	/**
	 * @cfg {String} groupTextTpl The template used to render the group header.
	 *      This is used to format an object which contains the following
	 *      properties: <div class="mdetail-params">
	 *      <ul>
	 *      <li><b>group</b> : String
	 *      <p class="sub-desc">
	 *      The <i>rendered</i> value of the group field. By default this is
	 *      the unchanged value of the group field. If a {@link #groupRenderer}
	 *      is specified, it is the result of a call to that.
	 *      </p>
	 *      </li>
	 ...
	 *      <li><b>text</b> : String
	 *      <p class="sub-desc">
	 *      The configured {@link #header} (If {@link #showGroupName} is true)
	 *      plus the <i>rendered</i>group field value.
	 *      </p>
	 *      </li>
	 ...
	 *      <li><b>rs</b> : Array
	 *      <p class="sub-desc">
	 *      .Contains a single element: The Record providing the data for the
	 *      row which caused group change.
	 *      </p>
	 *      </li>
	 *      <li><b>cls</b> : String
	 *      <p class="sub-desc">
	 *      The generated class name string to apply to the group header
	 *      Element.
	 *      </p>
	 *      </li>
	 *      <li><b>style</b> : String
	 ...
	 *      </div>
	 *      </p>
	 *      See {@link Ext.XTemplate} for information on how to format data
	 *      using a template.
	 */
	groupTextTpl : '{text}',
	/**
	 * @cfg {Function} groupRenderer The function used to format the grouping
	 *      field value for display in the group header. Should return a string
	 *      value. This takes the following parameters: <div
	 ...
	 */
	/**
	 * @cfg {String} header The text with which to prefix the group field value
