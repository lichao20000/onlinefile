 ...
 *          </p>
 *          <p>
 *          The BasicForm is configured using the {@link #initialConfig} of the
 *          FormPanel - that is the configuration object passed to the
 *          constructor. This means that if you subclass FormPanel, and you wish
 *          to configure the BasicForm, you will need to insert any
 *          configuration options for the BasicForm into the
 *          <tt><b>initialConfig</b></tt> property. Applying BasicForm
 *          configuration settings to <b><tt>this</tt></b> will not affect
 *          the BasicForm's configuration.
 *          </p>
 *          <br>
 *          <br>
...
Ext.FormPanel = Ext.extend(Ext.Panel, {
			/**
			 * @cfg {String} formId (optional) The id of the FORM tag (defaults
			 *      to an auto-generated id).
			 */
			/**
			 * @cfg {Number} labelWidth The width of labels. This property
			 *      cascades to child containers and can be overridden on any
			 *      child container (e.g., a fieldset can specify a different
			 *      labelWidth for its fields).
			 */
			/**
			 ...
			 *      child containers and can be overridden on any child
			 *      container (e.g., a fieldset can specify a different
