...
/*
 * This is code is also distributed under MIT license for use with jQuery and
 * prototype JavaScript libraries.
 */
/**
 * @class Ext.DomQuery Provides high performance selector/xpath processing by
 *        compiling queries into reusable functions. New pseudo classes and
 *        matchers can be plugged. It works on HTML and XML documents (if a
 *        content node is passed in).
 *        <p>
...
Ext.DomQuery = function() {
	...
	return {
		 ...
		 * long as the match the format <i>c</i>= where <i>c</i> is any
		...
		/**
		 * Collection of "pseudo class" processors. Each processor is passed the
		 * current nodeset (array) and the argument (if any) supplied in the
		 * selector.
		 */
		pseudos : {
