...
/**
 * @class Ext.Template Represents an HTML fragment template. Templates can be
 *        precompiled for greater performance. For a list of available format
 *        functions, see {@link Ext.util.Format}.<br />
 *        Usage:
 * 
 * <pre><code>
 ...
 * </code></pre>
 * 
 * For more information see this blog post with examples: <a
 ...
 * @constructor
 * @param {String/Array}
 *            html The HTML fragment or an array of fragments to join("") or
 *            multiple arguments to join("")
 */
...
Ext.Template.prototype = {
	 ...
	 *            html
	 * @param {Boolean}
	 *            compile (optional) True to compile the template (defaults to
	 *            undefined)
