...
Ext.util.TaskRunner = function(interval) {
	 ...
	 * 
	 * @param {Object}
	 *            task A config object that supports the following properties:
	 *            <ul>
	 *            <li><code>run</code> : Function<div class="sub-desc">The
	 *            function to execute each time the task is run. The function
	 *            will be called at each interval and passed the
	 *            <code>args</code> argument if specified. If a particular
	 *            scope is required, be sure to specify it using the
	 *            <code>scope</scope> argument.</div></li>
...
/**
 * @class Ext.TaskMgr A static {@link Ext.util.TaskRunner} instance that can be
 *        used to start and stop arbitrary tasks. See
