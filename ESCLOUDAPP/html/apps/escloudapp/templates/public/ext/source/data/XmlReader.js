 ...
 *          {@link Ext.data.Record} objects from an XML document based on
 ...
 * </code></pre>
 * 
 * @cfg {String} totalRecords The DomQuery path from which to retrieve the total
 *      number of records in the dataset. This is only needed if the whole
 ...
 *            to {@link Ext.data.Record#create}, or a Record constructor object
...
Ext.extend(Ext.data.XmlReader, Ext.data.DataReader, {
			 ...
			 * 
			 * @param {Object}
			 *            response The XHR object which contains the parsed XML
			 *            document. The response is expected to contain a
			 *            property called <tt>responseXML</tt> which refers to
			...
			readRecords : function(doc) {
				/**
				 * After any data loads/reads, the raw XML Document is available
