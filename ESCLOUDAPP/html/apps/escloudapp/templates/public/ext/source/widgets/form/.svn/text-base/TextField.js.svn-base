...
Ext.form.TextField = Ext.extend(Ext.form.Field, {
	...
	/**
	 * @cfg {Boolean} enableKeyEvents True to enable the proxying of key events
	 *      for the HTML input field (defaults to false)
	 */
	...
	initComponent : function() {
		...
		this.addEvents(
				...
				/**
				 * @event keydown Keydown input field event. This event only
				 *        fires if enableKeyEvents is set to true.
				...
				'keydown',
				/**
				 * @event keyup Keyup input field event. This event only fires
				 *        if enableKeyEvents is set to true.
				 * @param {Ext.form.TextField}
				 *            this This text field
				 * @param {Ext.EventObject}
				 *            e
				...
				'keyup',
				/**
				 * @event keypress Keypress input field event. This event only
				 *        fires if enableKeyEvents is set to true.
				 * @param {Ext.form.TextField}
				 *            this This text field
				 * @param {Ext.EventObject}
	 ...
	 * and fires the {@link #autosize} event.
	 */
	autoSize : function() {
