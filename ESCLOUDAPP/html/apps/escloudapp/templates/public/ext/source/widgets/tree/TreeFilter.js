...
/**
 * @class Ext.tree.TreeFilter Note this class is experimental and doesn't update
 *        the indent (lines) or expand collapse icons of the nodes
 * @param {TreePanel}
 *            tree
 * @param {Object}
 *            config (optional)
...
Ext.tree.TreeFilter.prototype = {
	...
	/**
	 * Clears the current filter. Note: with the "remove" option set a filter
	 * cannot be cleared.
	 */
	clear : function() {
		var t = this.tree;
