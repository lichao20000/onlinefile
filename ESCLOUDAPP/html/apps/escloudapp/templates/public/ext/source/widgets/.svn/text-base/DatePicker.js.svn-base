 ...
 * @constructor Create a new DatePicker
 * @param {Object}
...
Ext.DatePicker = Ext.extend(Ext.Component, {
	 ...
	 */
	/**
	 * @cfg {Array} disabledDays An array of days to disable, 0-based. For
	 *      example, [0, 6] disables Sunday and Saturday (defaults to null).
	 */
	/**
	 * @cfg {RegExp} disabledDatesRE JavaScript regular expression used to
	 *      disable a pattern of dates (defaults to null). The
	 *      {@link #disabledDates} config will generate this regex internally,
	 *      but if you specify disabledDatesRE it will take precedence over the
	 *      disabledDates value.
	 */
	/**
	 * @cfg {Array} disabledDates An array of "dates" to disable, as strings.
	 ...
	 *      <li>["^03/08"] would only match the beginning (useful if you are
	 *      using short years)</li>
