...
/**
 * @class Ext.grid.PropertyRecord A specific {@link Ext.data.Record} type that
 *        represents a name/value pair and is made to work with the
 *        {@link Ext.grid.PropertyGrid}. Typically, PropertyRecords do not need
 *        to be created directly as they can be created implicitly by simply
 *        using the appropriate data configs either via the
 *        {@link Ext.grid.PropertyGrid#source} config property or by calling
 *        {@link Ext.grid.PropertyGrid#setSource}. However, if the need arises,
 *        these records can also be created explicitly as shwon below. Example
 *        usage:
 * 
 * <pre><code>
...
Ext.grid.PropertyGrid = Ext.extend(Ext.grid.EditorGridPanel, {
			 ...
			 * {@link #store}. The values should be supplied in the proper data
			 * type if needed, otherwise string type will be assumed. If the
			 * grid already contains data, this method will replace any existing
			 * data. See also the {@link #source} config value. Example usage:
			 * 
			 * <pre><code>
			 * grid.setSource({
			 * 			&quot;(name)&quot; : &quot;My Object&quot;,
