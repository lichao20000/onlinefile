 ...
 * @class Ext.Fx
 *        <p>
 *        A class to provide basic animation and visual effects support.
 *        <b>Note:</b> This class is automatically applied to the
 *        {@link Ext.Element} interface when included, so all effects calls
 *        should be performed via Element. Conversely, since the effects are not
 *        actually defined in Element, Ext.Fx <b>must</b> be included in order
 *        for the Element effects to work.
 *        </p>
 *        <br/>
 * 
 * <p>
...
Ext.Fx = {
	 ...
	 * handles wrapping the element with a fixed-size container if needed. See
	 * the Fx class overview for valid anchor point options. Usage:
	 * 
	 * <pre><code>
	 ...
	 * 
	 * @param {String}
	 *            anchor (optional) One of the valid Fx anchor positions
	 *            (defaults to top: 't')
	 * @param {Object}
	 ...
	 * from the DOM using the 'remove' config option if desired. This function
	 * automatically handles wrapping the element with a fixed-size container if
	 * needed. See the Fx class overview for valid anchor point options. Usage:
	 * 
	 * <pre><code>
	 ...
	 * The element must be removed from the DOM using the 'remove' config option
	 * if desired. Usage:
	 * 
	 * <pre><code>
	 * // default
	 ...
	 * el.frame(&quot;C3DAF9&quot;, 1, {
	 * 	duration : 1
	 * 		//duration of entire animation (not each individual ripple)
	 * 		// Note: Easing is not configurable and will be ignored if included
	 * 	});
	 * </code></pre>
	 * 
	 * @param {String}
	 *            color (optional) The color of the border. Should be a 6 char
	 *            hex color without the leading # (defaults to light blue:
	 *            'C3DAF9').
	 * @param {Number}
	 *            count (optional) The number of ripples to display (defaults to
	 *            1)
	 * @param {Object}
	 *            options (optional) Object literal with any of the Fx config
	 *            options
	 ...
	 * be specified using the "endOpacity" config option. Usage:
	 * 
	 * <pre><code>
	 ...
	 * be specified using the "endOpacity" config option. Note that IE may
	 ...
	 * 
	 * @param {Number}
	 *            width The new width (pass undefined to keep the original
	 *            width)
	 * @param {Number}
	 *            height The new height (pass undefined to keep the original
	 *            height)
	 * @param {Object}
	 *            options (optional) Object literal with any of the Fx config
	 *            options
	 ...
	 * config object in order for the function to have any effect. Usage:
	 * 
	 * <pre><code>
	 ...
	 * are run in sequence. This is the opposite of {@link #syncFx}.
	 * 
	 * @return {Ext.Element} The Element
	 */
	sequenceFx : function() {
