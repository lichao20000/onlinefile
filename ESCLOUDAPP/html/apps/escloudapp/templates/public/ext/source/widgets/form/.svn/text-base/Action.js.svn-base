 ...
 *        {@link Ext.form.BasicForm Form}s.
 *        </p>
 *        <p>
 ...
 *        {@link Ext.form.BasicForm#doAction doAction}
 *        </p>
 *        <p>
...
Ext.form.Action.prototype = {
	 ...
	 */
	/**
	 * @cfg {Boolean} reset When set to <tt><b>true</b></tt>, causes the
	 *      Form to be {@link Ext.form.BasicForm.reset reset} on Action success.
	 *      If specified, this happens <b>before</b> the {@link #success}
	 *      callback is called and before the Form's
	 *      {@link Ext.form.BasicForm.actioncomplete actioncomplete} event
	 *      fires.
	 */
	/**
	 ...
	 */
	/**
	 * @cfg {Number} timeout The number of milliseconds to wait for a server
	 *      response before failing with the {@link #failureType} as
	 *      {@link #CONNECT_FAILURE}.
	 */
	/**
	 ...
	 * {@link #Ext.form.Action.CLIENT_INVALID CLIENT_INVALID},
	 * {@link #Ext.form.Action.SERVER_INVALID SERVER_INVALID},
	 * {@link #Ext.form.Action.CONNECT_FAILURE CONNECT_FAILURE},
	 * {@link #Ext.form.Action.LOAD_FAILURE LOAD_FAILURE}
	 * 
 ...
 *          <p>
 *          Instances of this class are only created by a
 *          {@link Ext.form.BasicForm Form} when
 ...
 *          response packet may look like this:
 *          </p>
 * 
 * <pre><code>
 *  {
 ...
 * 
 * <p>
 *          Other data may be placed into the response for processing by the
 ...
 *          </p>
 *          <p>
 *          Alternatively, if an {@link #errorReader} is specified as an
 ...
 * 
 * <p>
 *          Other elements may be placed into the response XML for processing by
 *          the {@link Ext.form.BasicForm}'s callback or event handler methods.
 *          The XML document is available in the {@link #errorReader}'s
 *          {@link Ext.data.XmlReader#xmlData xmlData} property.
 *          </p>
 */
...
Ext.extend(Ext.form.Action.Submit, Ext.form.Action, {
			/**
			 * @cfg {Ext.data.DataReader} errorReader <b>Optional. JSON is
			 *      interpreted with no need for an errorReader.</b>
			 *      <p>
			 *      A Reader which reads a single record from the returned data.
			 *      The DataReader's <b>success</b> property specifies how
			 *      submission success is determined. The Record's data provides
			 *      the error messages to apply to any invalid form Fields.
			 *      </p>.
			 */
			/**
 ...
 * @extends Ext.form.Action
 *          <p>
 *          A class which handles loading of data from a server into the Fields
 *          of an {@link Ext.form.BasicForm}.
 *          </p>
 *          <p>
 *          Instances of this class are only created by a
 *          {@link Ext.form.BasicForm Form} when
