...
Date.monthNames = ["Január", "Február", "Március", "Április", "Május",
...
Date.dayNames = ["Vasárnap", "Hétfő", "Kedd", "Szerda", "Csütörtök", "Péntek",
		"Szombat"];
...
if (Ext.form.VTypes) {
	Ext.apply(Ext.form.VTypes, {
		...
		urlText : 'A mezÅ‘ webcÃ­met tartalmazhat, melynek formÃ¡tuma "http:/'
				+ '/www.weboldal.hu"',
