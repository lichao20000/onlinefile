 ...
 * @extends Ext.Button A split button that provides a built-in dropdown arrow
 *          that can fire an event separately from the default click event of
 *          the button. Typically this would be used to display a dropdown menu
 *          that provides additional options to the primary button action, but
 *          any custom handler can provide the arrowclick implementation.
 *          Example usage:
 * 
 * <pre><code>
 ...
 * </code></pre>
 * 
 * @cfg {Function} arrowHandler A function called when the arrow button is
 *      clicked (can be used instead of click event)
 * @cfg {String} arrowTooltip The title attribute of the arrow
 * @constructor Create a new menu button
 * @param {Object}
...
Ext.SplitButton = Ext.extend(Ext.Button, {
	...
	initComponent : function() {
		...
		/**
		 * @event arrowclick Fires when this button's arrow is clicked
		 * @param {MenuButton}
		 *            this
		 * @param {EventObject}
		 *            e The click event
	 ...
	 * 
	 * @param {Function}
	 *            handler The function to call when the arrow is clicked
	 * @param {Object}
	 *            scope (optional) Scope for the function passed above
	 */
