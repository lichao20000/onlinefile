...
$baseUrl = '/files/communityimage/';
//$baseUrl = '/apps/onlinefile/templates/ESUserCommunity/ckfinder/userfiles/';
/*
...
*/
$baseDir = resolveUrl($baseUrl);
//$baseDir = 'D:/javaDevlop/Workspace/ESCLOUDAPP/html/files/communityimage/';
