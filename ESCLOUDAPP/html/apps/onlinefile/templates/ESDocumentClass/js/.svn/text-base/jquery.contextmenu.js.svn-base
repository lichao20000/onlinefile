...
//        if(item.label=='成员管理' && $("#showPersonId").val()=='2'){	//用于分组显示菜单  就是不同的分类级别显示不同的菜单
//        	row.closest('li').css("display","none");
//        }
//        if(item.label=='删除' && $("#showPersonId").val()=='2'){
//        	row.closest('li').css("display","none");
//        }
//        if(item.label=='重命名' && $("#showPersonId").val()=='2'){
//        	row.closest('li').css("display","none");
//        }
//        if(item.label=='删除' && $("#showPersonId").val()=='1'){
//        	row.closest('li').css("display","none");
//        }
//        if(item.label=='重命名' && $("#showPersonId").val()=='1'){
//        	row.closest('li').css("display","none");
//        }
        if (item.action) {
