...
//			title.show().html(text || '');  //现在没有title了，隐藏掉
...
+										'<div class="aui_title" style="display: none;"></div>'
...
artDialog.noticeOld = function (options) {
	...
	var cWidth = document.documentElement.clientWidth || document.body.clientWidth;
	 ...
	 if('succeed' == options.icon || 'success' == options.icon){//成功
		 ...
		 document.getElementById('messageUIImg').src = artDialog.defaults.path+'/images/nothing.png';
		 
	 }
	 var startY = -(document.getElementById("msgDiv").offsetHeight*1);
	 /** liqiubo 20150129 为了和加载中的样式不重叠，宽度修改为450**/
	 /** xiaoxiong 20130609 修改提示消息组建的最大宽度为600 **/
	 if(document.getElementById("msgDiv").offsetWidth>450){
	 	document.getElementById('msgDiv').style.width = 450+'px';
	 	document.getElementById('msgDiv').style.left = (cWidth-450)/2+'px';
	 } else {
