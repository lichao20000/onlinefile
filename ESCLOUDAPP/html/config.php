...
$config['sso.login'] = 'http://127.0.0.1/Default';
...
$config['sso.passivelogout'] = 'http://127.0.0.1:8080/flyingoauth/logout?returnUrl=%s&passiveLogout=http://127.0.0.1:8080/Default/?error=5';
...
$config['openfireservername'] = 'im.flying.cn';
$config['openfirebaseurl'] = 'http://127.0.0.1:9090';
$config['sso.onlinefile'] = 'http://127.0.0.1:8080/onlinefile';