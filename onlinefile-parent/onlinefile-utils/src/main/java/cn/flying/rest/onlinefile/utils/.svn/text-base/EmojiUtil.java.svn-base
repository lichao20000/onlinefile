...
public class EmojiUtil {
	...
	public static final String STATIC_EMOJI_PREFIX = "emoji_";
	public static final String DYNAMIC_FACE_PREFIX = "f";
	public static final String STATIC_FACE_END = ".png";
	...
	public String getMapKey(String value) {
		if (mEmojiMap.containsValue(value)) {

			Set<String> kset = mEmojiMap.keySet();
			for (String ks : kset) {
				if (value.equals(mEmojiMap.get(ks))) {
					return ks;
				}
			}
		}
	...
	public Pattern buildPattern() {
		if (mPattern == null) {
			StringBuilder patternString = new StringBuilder(mEmojiMap.size());
			patternString.append('(');
			for (String s : mEmojiMap.keySet()) {
